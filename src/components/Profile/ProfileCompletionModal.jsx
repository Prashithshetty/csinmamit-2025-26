      ...
      <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
        ...
        >
          ...
          >
            ...
            {/* Input fields for name, phone, branch, year, usn */}
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 rounded-lg border ${
                  errors.usn
                    ? "border-red-500"
                    : "border-gray-300 dark:border-gray-700"
                } bg-white dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 uppercase`}
              />
              {errors.usn && (
